...
class ApprovedDebitHistoryHistoryAdapter(var hist_modelArrayList: ArrayList<TransactionHistModel>) :
    RecyclerView.Adapter<ApprovedDebitHistoryHistoryAdapter.wallet_transHist>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): wallet_transHist {
        val v = LayoutInflater.from(parent.context).inflate(R.layout.approved_debit_history_item,parent,false)
