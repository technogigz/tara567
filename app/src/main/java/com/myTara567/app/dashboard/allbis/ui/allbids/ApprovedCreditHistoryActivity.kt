...
import com.myTara567.app.databinding.ActivityApprovedCreditHistoryBinding
import com.myTara567.app.serverApi.controller
import retrofit2.Call
import retrofit2.Callback
import retrofit2.Response

class ApprovedCreditHistoryActivity : AppCompatActivity() {

    private lateinit var binding: ActivityApprovedCreditHistoryBinding
   ...
   private var mTitle: String? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityApprovedCreditHistoryBinding.inflate(layoutInflater)
    ...
    private fun mInitView() {
        ...
        val walletTitle = intent.getStringExtra("Wallet")
            ...
            override fun onResponse(call: Call<JsonObject>, response: Response<JsonObject>) {
                ...
                if (response.isSuccessful) {
                    ...
                    if (responseBody != null) {
                        val transactionHist = responseBody.getAsJsonArray("in_history")
                        ...
                        if (status) {
                            if (transactionHist.size() == 0) {
                                ...
                                for (i in 0 until transactionHist.size()) {
                                    ...
                                    val model = TransactionHistModel().apply {
                                        this.amount = amount
                                ...
                                recyclerView.layoutManager = LinearLayoutManager(this@ApprovedCreditHistoryActivity)
                                recyclerView.adapter = ApprovedCreditHistoryAdapter(histModelsList)
