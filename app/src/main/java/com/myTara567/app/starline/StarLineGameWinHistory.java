...
import com.myTara567.app.dashboard.winHistoryAdapter;
import com.myTara567.app.dashboard.winHistoryModel;
...
public class StarLineGameWinHistory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dateFrom.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(StarLineGameWinHistory.this,
    ...
    private void starLineWinhist() {
        ...
        Call<JsonObject> call = controller.getInstance().getApi().starLine_game_winHist(js);
